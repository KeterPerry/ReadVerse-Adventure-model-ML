...
#directory -path to the directory containing the training data
# model_output_path-path to the output directory for the trained model and tokenizer

def main():
    print("main")
    directory = "myData"  # Replace with the path to your directory containing the files
    ...
    # Test the chatbot
    prompt = "give me 5 sentences about home"  # Replace with your desired prompt
